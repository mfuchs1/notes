...
#+OPTIONS: toc:nil
#+STARTUP: fnadjust
#+export_file_name: ~/Documents/exports/Lev 5.html
...
hat, aber er zeigt es nicht an und lädt damit Schuld auf sich; [fn:1]
...
geraubtes Gut täuscht oder ihn übervorteilt [fn:3]
...
[fn:1] Wie noch heute bei den Beduinen, so hat man in Israel
...
[fn:2] aber er merkt es dann: sinngemäß ergänzt (vgl. V. 3).

[fn:3] (21-26) Ex 22,6-14 [[file:Ex_22.org::v6][Ex 22,6-14]]
