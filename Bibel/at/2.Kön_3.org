...
#+OPTIONS: toc:nil
#+STARTUP: fnadjust
#+export_file_name: ~/Documents/exports/2 Kln 3.html
...
das sein Vater errichtet hatte. [fn:1]
...
Volk, meine Pferde mit deinen Pferden. [fn:3]
...
ihnen das Wasser drüben rot wie Blut. [fn:5]
...
Israeliten nach und machten sie nieder. [fn:6]
...
[fn:1] [[file:1.Kön_16.org::v32][1 Kön 16,32]]

[fn:2] Über die Erfolge Meschas berichtet ein nach ihm benannter Gedenkstein.

[fn:3] [[file:1.Kön_22.org::v4][1 Kön 22,4]]

[fn:4] Der Hinweis auf das Speiseopfer ist Zeitangabe wie in [[file:1.Kön_18.org::v29][1 Kön 18,29]].

[fn:5] Die rote Färbung des Wassers könnte vom mitgeführten
Sand oder von einer Luftspiegelung kommen, bei der das Wasser unter der
aufgehenden Sonne rot erschien.

[fn:6] drängten die Israeliten nach: Text korr. nach G.
