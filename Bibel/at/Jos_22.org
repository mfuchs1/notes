...
#+OPTIONS: toc:nil
#+STARTUP: fnadjust
#+export_file_name: ~/Documents/exports/Jos 22.html
...
Manasse dort am Jordan einen Altar von stattlichem Aussehen. [fn:2]
...
Gemeinde des Herrn gekommen. [fn:3]
...
nicht für seinen Frevel sterben? [fn:5]
...
Herrn war, dann soll er uns heute nicht helfen. [fn:6]
...
Er steht mitten unter uns als Zeuge dafür, dass Jahwe Gott ist. [fn:7]\\
\\

* Footnotes

[fn:1] [[file:Num_32.org::v20][Num 32,20-22]]; [[file:Dtn_3.org::v18][Dtn 3,18-20]]

[fn:2] 10-34: Die Kritik an dem Altar geht von dem Grundsatz
aus, dass es nur ein einziges Heiligtum in Israel geben darf (vgl. [[file:Dtn_12.org::v4][Dtn 12,4-7]]).

[fn:3] [[file:Num_25.org::v1][Num 25]]

[fn:4] Gott hat sein Heiligtum im Westjordanland. Wenn das Land
östlich des Jordan als unrein betrachtet wird, ist die Verehrung Gottes
dort nicht möglich. - zieht uns . . . hinein: Text korr.

[fn:5] ℘ [[file:Jos_7.org::v1][7,1-26]]

[fn:6] soll er uns nicht helfen: Text korr., mit den alten
Übersetzungen; H: hilf du uns nicht!

[fn:7] Zeuge: Text korr., eingefügt mit einigen H-Handschriften
und S (vgl. [[v7][V. 27]]).
