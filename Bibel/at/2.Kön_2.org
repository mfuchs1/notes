...
#+OPTIONS: toc:nil
#+STARTUP: fnadjust
#+export_file_name: ~/Documents/exports/2 Kön 2.html
...
wollte, ging Elija mit Elischa von Gilgal weg. [fn:1]
...
[fn:1] Gilgal ist nicht der in [[file:Jos_4.org::v19][Jos 4,19]] genannte Ort bei
Jericho, sondern ein Ort nördlich von Bet-El.

[fn:2] Prophetenjünger: die Mitglieder der Prophetengemeinschaften.

[fn:3] Durch die Verleihung von zwei Anteilen des Geistes des
Elija fällt Elischa die Stellung eines Erstgeborenen zu (vgl. [[file:Dtn_21.org::v17][Dtn 21,17]]).

[fn:4] Der Ausruf drückt die Bedeutung Elijas aus. Der
Kriegswagen gehörte zur wirkungsvollsten Ausrüstung des damaligen Heeres.
