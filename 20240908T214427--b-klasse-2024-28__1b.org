...
*** Karwoche - die letzte Woche Jesu in Jerusalem
:PROPERTIES:
:CUSTOM_ID: h:248a7575-fd78-4c40-bfc5-5a4bfd200101
:END:

Evangelien zu Palmsonntag, Gründonnerstag, Karfreitag:
[[file:~/MMS_Abtenau/Texte_Karwoche.odt]]

Bilder zur Karwoche zum Ausmalen:
[[file:~/MMS_Abtenau/Karwoche_Bilder/]]

Ins Heft (sauber arbeiten!):
- Texte und Bilder zuordnen
- Texte lesen / vorlesen
- ins Heft kleben
- Bilder ausmalen

Texte sind (so weit es möglich war), in den liturgischen Farben ausgedruckt.

Ich werde Texte und Bilder Schritt für Schritt austeilen.
